      ...
      <section className="min-h-screen bg-white font-sans flex flex-col justify-center">
        <div className="w-full border-y border-gray-300 flex-1 flex flex-col bg-white mt-16 mb-16">
          <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col lg:flex-row border-x border-gray-300 relative">
            {/* Top Right "Sign up" (Positioned relative to the card) */}
                ...
                <form className="flex flex-col gap-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#F5F5F7] border focus:border-gray-300 focus:bg-white text-black text-sm rounded-sm pl-10 pr-4 py-3.5 transition-all outline-none font-semibold placeholder:text-gray-500 placeholder:font-medium"
                      required
                    />
                  </div>
                  ...
                  <div className="relative mb-1">
                    ...
                    <input
                      ...
                      placeholder="••••••••••••"
                      className="w-full bg-[#F5F5F7] border focus:border-gray-300 focus:bg-white text-black text-sm rounded-sm pl-10 pr-10 py-3.5 transition-all outline-none font-semibold placeholder:text-gray-500 placeholder:font-medium"
                      required
                    />
                    <button
                      type="button"
